...
begin
	...
	using CSV
	using DataFrames # to load .tsv file 
...
# ╔═╡ 26827ae1-7285-4eed-8c2c-12c772460768
...
# ╔═╡ e474e40c-087b-4495-afbf-662a262f789c
begin
	lines(1:10000,data[1,1:10000])
	current_figure()
	
end

# ╔═╡ d3d915b9-573c-43f8-bc47-1c39560050f2
b_fixation = firbasis(τ=(-0.5,0.5),sfreq=sfreq,name="fixation");

# ╔═╡ 21baaa62-7c1e-4968-8140-6804f2c8f32e
f_amp = @formula 0~1 + spl(sac_amplitude,5); 

# ╔═╡ 784b95b8-db26-49a7-b242-3aec12a6ff3b
model_fit = Unfold.fit(UnfoldLinearModelContinuousTime,Dict("fixation"=>(f_amp,b_fixation)),events,data,eventcolumn="type")

# ╔═╡ fa03b534-a505-412f-93f9-3841bbf46d8f
begin
df = coeftable(model_fit)
df.channel = channel_list[df.channel]
end

# ╔═╡ ce5a9304-e6d8-4004-8bbf-ad52a6cab426
result = coeftable(model_fit)

# ╔═╡ a726fbad-1791-47aa-9417-0f180931cb30
plot_results(result)

# ╔═╡ 1e573be6-e394-42a4-8c03-bcad972c78e0
predict(model_fit,DataFrame("sac_amplitude"=>1:5))

# ╔═╡ 5e1d9864-9a79-494c-970b-1556c4275904
eff = Unfold.effects(Dict(:sac_amplitude=>1:5),model_fit)
...
git-tree-sha1 = "c68eec61c7014054d4f2546806be14a63fbff181"
